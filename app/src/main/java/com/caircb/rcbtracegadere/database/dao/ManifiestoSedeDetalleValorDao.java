...
public abstract class ManifiestoSedeDetalleValorDao {
    ...
    @Query("select idManifiestoDetalle,idManifiestoDetalleValor as idManifiestoDetalleValores,peso,codigoQR,nombreBulto,estado,estadoChecks from tb_manifiestos_sede_det_valor where idManifiestoDetalle=:idManifiesto" )
    @Transaction
    ...
    @Query("select idManifiestoDetalle from tb_manifiestos_sede_det_valor where estado = 1 and estadoEnvio = 1")
    public abstract List<Integer> fetchDetallesRecolectadosByIdeManifiestoDetalle();
