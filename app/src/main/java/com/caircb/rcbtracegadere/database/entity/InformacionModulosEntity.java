...
@Entity(tableName = (InformacionModulosEntity.TABLE))
public class InformacionModulosEntity {
    public static final String TABLE = "tb_informacionModulos";

    @PrimaryKey(autoGenerate = true)
    private Integer idInformacionModulos;
    private String ruta;
    ...
    public Integer getIdInformacionModulos() {
        return idInformacionModulos;
    }

    public void setIdInformacionModulos(Integer idInformacionModulos) {
        this.idInformacionModulos = idInformacionModulos;
    }
