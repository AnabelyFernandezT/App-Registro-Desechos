...
public abstract class ManifiestoDao {
    ...
    @Query("select count(*) from tb_manifiestos where idChoferRecolector=:idConductor  and idSubRuta=:idSubRuta and estado=2 or estado= 6")
    ...
    @Query("select idAppManifiesto,nombreCliente as cliente,numeroManifiesto as numero,'' as sucursal, direccionCliente as direccion,provincia as provincia, canton as canton, estado,apertura1 as Apertura1,apertura2 as Apertura2,cierre1 as Cierre1,cierre2 as Cierre2, sucursal as sucursal, tecnicoTelefono as telefono, frecuencia as frecuencia, tipoPaquete as tipoPaquete from tb_manifiestos where idSubRuta=:Subruta and idChoferRecolector=:idChoferRecolector and estado in(2) or estado in(6)  order by nombreCliente")
    @Transaction
    ...
    @Query("select idAppManifiesto,nombreCliente as cliente,numeroManifiesto as numero,'' as sucursal, direccionCliente as direccion," +
            "provincia as provincia, canton as canton, estado, tipoPaquete as tipoPaquete," +
            " apertura1 as Apertura1,apertura2 as Apertura2,cierre1 as Cierre1,cierre2 as Cierre2, sucursal as sucursal, identificacionCliente as identificacion " +
            "from tb_manifiestos " +
    ...
    @Query("select idAppManifiesto,nombreCliente as cliente,numeroManifiesto as numero,'' as sucursal, direccionCliente as direccion," +
            ...
            " apertura1 as Apertura1,apertura2 as Apertura2,cierre1 as Cierre1,cierre2 as Cierre2, sucursal as sucursal " +
            "from tb_manifiestos " +
            "where estado=1  and idChoferRecolector=:idChoferRecolector order by nombreCliente")
    @Transaction
    public abstract List<ItemManifiesto> fetchManifiestosA(Integer idChoferRecolector);
    ...
    @Query("select idAppManifiesto,nombreCliente as cliente,numeroManifiesto as numero,'' as sucursal, direccionCliente as direccion,provincia as provincia, canton as canton, estado from tb_manifiestos " +
            "where estado=2 or estado=6 and (numeroManifiesto like '%' || :search || '%' or nombreCliente like '%' || :search || '%') and idSubRuta=:SubRuta and idChoferRecolector=:idChoferRecolector order by nombreCliente")
    @Transaction
    ...
    */
    ...
    @Query("update tb_manifiestos set estado=6, sincronizado=1 where idAppManifiesto=:idAppManifiesto ")
