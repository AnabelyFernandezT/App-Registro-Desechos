...
public class UserRegistrarNoRecoleccion extends MyRetrofitApi implements RetrofitCallbacks {
    ...
    public UserRegistrarNoRecoleccion(Context context,
                                      Integer idAppManifiesto,
                                      Location location) {
        super(context);
