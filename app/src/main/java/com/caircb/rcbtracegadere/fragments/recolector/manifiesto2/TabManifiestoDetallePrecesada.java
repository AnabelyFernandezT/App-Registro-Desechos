...
import com.caircb.rcbtracegadere.adapters.ManifiestoDetalleAdapterProcesado;
...
public class TabManifiestoDetallePrecesada extends LinearLayout {

    private List<RowItemManifiesto> detalles;
    private RecyclerView recyclerView;

    ManifiestoDetalleAdapterProcesado recyclerviewAdapter;
    ...
    public TabManifiestoDetallePrecesada(Context context, Integer manifiestoID, Integer tipoPaquete, String numeroManifiesto) {
        super(context);
    ...
    private void init(){
        ...
        recyclerviewAdapter = new ManifiestoDetalleAdapterProcesado(getContext(),numeroManifiesto);
    }
    ...
    private void loadData(){
        ...
        /*recyclerviewAdapter.setOnItemClickListener(new ManifiestoDetalleAdapterProcesado().ClickListener() {
            @Override
