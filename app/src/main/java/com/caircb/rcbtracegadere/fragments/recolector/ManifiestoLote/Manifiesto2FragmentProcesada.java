...
public class Manifiesto2FragmentProcesada extends MyFragment implements OnCameraListener,View.OnClickListener {
    ...
    TabManifiestoGeneralLote tabManifiestoGeneral;
    TabManifiestoDetalleLote tabManifiestoDetalle;
    TabManifiestoAdicionalLote tabManifiestoAdicional;
    ...
    private void inicializeTab(){
        ...
        tabManifiestoGeneral = new TabManifiestoGeneralLote(getActivity(),idAppManifiesto,estado);

        tabManifiestoDetalle = new TabManifiestoDetalleLote(getActivity(),
                idAppManifiesto,
                tabManifiestoGeneral.getTipoPaquete(),
                tabManifiestoGeneral.getNumeroManifiesto(),
                estado,1);

        tabManifiestoAdicional = new TabManifiestoAdicionalLote(getActivity(),
                idAppManifiesto,
                tabManifiestoGeneral.getTipoPaquete(),
