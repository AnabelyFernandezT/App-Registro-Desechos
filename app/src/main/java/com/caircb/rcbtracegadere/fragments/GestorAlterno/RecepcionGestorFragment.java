...
public class RecepcionGestorFragment extends LinearLayout  {
...
public RecepcionGestorFragment(Context context, Integer idAppManifiesto){
    super(context);
    this.idManifiesto = idAppManifiesto;
    View.inflate(context, R.layout.fragment_recoleccion_gestor, this);
    init();
    load();
