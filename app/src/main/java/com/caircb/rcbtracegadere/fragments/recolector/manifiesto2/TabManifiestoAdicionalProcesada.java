...
import com.caircb.rcbtracegadere.adapters.ManifiestoNovedadBaseAdapterRProcesada;
...
public class TabManifiestoAdicionalProcesada extends LinearLayout {
    ...
    ManifiestoNovedadBaseAdapterRProcesada recyclerAdapterNovedades;
    ...
    public TabManifiestoAdicionalProcesada(Context context,
    ...
    private void loadData(){
       novedadfrecuentes = MyApp.getDBO().manifiestoObservacionFrecuenteDao().fetchHojaRutaCatalogoNovedaFrecuente(idAppManifiesto);
        ...
        recyclerAdapterNovedades = new ManifiestoNovedadBaseAdapterRProcesada(getContext(), novedadfrecuentes, bloquear,idAppManifiesto);
       ...
       /* recyclerAdapterNovedades.setOnClickReaload(new ManifiestoNovedadBaseAdapterR.OnReloadAdater() {
        ...
        recyclerAdapterNovedades.setOnClickOpenFotografias(new ManifiestoNovedadBaseAdapterRProcesada.OnClickOpenFotografias() {
           @Override
