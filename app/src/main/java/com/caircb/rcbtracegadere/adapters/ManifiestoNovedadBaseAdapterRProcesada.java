...
public class ManifiestoNovedadBaseAdapterRProcesada extends RecyclerView.Adapter<ManifiestoNovedadBaseAdapterRProcesada.MyViewHolder> {
    ...
    private ManifiestoNovedadBaseAdapterRProcesada.OnClickOpenFotografias mOnClickOpenFotografias;
    private ManifiestoNovedadBaseAdapterRProcesada.OnReloadAdater mOnReloadAdaptador;

    public ManifiestoNovedadBaseAdapterRProcesada(Context context, List<RowItemHojaRutaCatalogo> items, boolean desactivarComp, Integer idManifiesto){
        mContext = context;
        listItems = items;
